...
<div class="container-fluid">
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Boiler Locations Main Image</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        <label for="exampleInputFile">Boiler Locations image <small></small></label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="boilerlocation_page_img" value="{{old('boilerlocation_page_img')}}" onchange="loadFile(event, 'boilerlocation_page_img')" required="">
                            <label class="custom-file-label" for="image_label2">{{ (@$image)?$image :'Choose file' }}</label>
                          </div>
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Edit Boiler Location Info</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-10 offset-md-1">
                      <textarea id = "main" class= "builder" name = "boilerlocation_firstcontainer">
                        <?php  
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="pageexampleInputFile" name="boiler_question_img" value="{{old('boiler_question_img')}}" onchange="loadFile(event, 'boiler_question_img')" required="">
                            <label class="custom-file-label" for="image_label">{{ (@$image2)?$image2 :'Choose file' }}</label>
                          </div>
          ...
          <div class="col-md-12 card card-primary">
              ...
              <form role="form" id="form" action="{{url('/boiler/option_update')}}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-10 offset-md-1">
                          <textarea id = "questions" class= "builder" name = "boilerlocation_questions">
                            <?php  
