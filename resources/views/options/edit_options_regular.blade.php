...
<div class="container-fluid">
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Regular Boiler Main Image</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        <label for="exampleInputFile">Regular Boiler image <small></small></label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="regularboiler_page_img" value="{{old('regularboiler_page_img')}}" onchange="loadFile(event, 'regularboiler_page_img')" required="">
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Edit Regular Boiler Info</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-10 offset-md-1">
                      <textarea id = "main" class= "builder" name = "regularboiler_firstcontainer">
                        <?php  
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="pageexampleInputFile" name="regularboiler_question_img" value="{{old('regularboiler_question_img')}}" onchange="loadFile(event, 'regularboiler_question_img')" required="">
                            <label class="custom-file-label" for="image_label2">{{ (@$image2)?$image2 :'Choose file' }}</label>
                          </div>
                               <span>image size : 183 * 293</span>
                        </div>
                      </div>
                    </div>
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Edit Regular Page Questions</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="form" action="{{url('/boiler/option_update')}}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-10 offset-md-1">
                          <textarea id = "questions" class= "builder" name = "regularboiler_questions">
                            <?php  
...
$(document).ready(function() {
  ...
  var loadFile = function(event, id = '') {
    if(id == 'regularboiler_question_img'){
