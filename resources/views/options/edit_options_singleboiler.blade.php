...
<div class="container-fluid">
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Single Boiler Brand Main Image</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        <label for="exampleInputFile">Single Boiler Brand image <small></small></label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="singleboiler_page_img" value="{{old('singleboiler_page_img')}}" onchange="loadFile(event, 'singleboiler_page_img')" required="">
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Edit Single Boiler Brand Info</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-10 offset-md-1">
                      <textarea id = "main" class= "builder" name = "singleboiler_firstcontainer">
                        <?php  
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="pageexampleInputFile" name="singleboiler_question_img" value="{{old('singleboiler_question_img')}}" onchange="loadFile(event, 'singleboiler_question_img')" required="">
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Edit Single Boiler Brand Page Questions</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="form" action="{{url('/boiler/option_update')}}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-10 offset-md-1">
                          <textarea id = "questions" class= "builder" name = "singleboiler_questions">
                            <?php  
...
$(document).ready(function() {
  ...
  var loadFile = function(event, id = '') {
    if(id == 'singleboiler_question_img'){
