...
<div class="container-fluid">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="comparison" value="{{old('comparison')}}" onchange="loadFile(event)" required="">
    ...
    <div class="container-fluid">
                          ...
                          <div class="card-body">
                            ...
                            <div class="row">
                              <div class="col-md-10 offset-md-1">
                                ...
                                "comparison_firstcontainer_boilertype" >
                                  <?php  
                                      if(isset($comparison_firstcontainer_boilertype) && ($comparison_firstcontainer_boilertype) ){
                                          echo $firstcontainerHtml = json_decode($comparison_firstcontainer_boilertype)->value;
                                      }
                                  ?>    
                                </textarea>
                              </div>
          ...
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Comparison Boiler Type</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="form" action="{{url('/boiler/option_update')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div id="center_image" class="w-50 mx-auto">
                        <img src="{{ (@$image1)?asset('images/boilerfinance/'.$image1):asset('images/no_image.jpg') }}" id="output1" width="125px" height="125px" style="border: 2px solid black;">
                      </div>
                    </div>
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        <label for="exampleInputFile">Comparison Boiler Type <small></small></label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="comparison_boilertype" value="{{old('comparison_boilertype')}}" onchange="loadFile(event)" required="">
                            <label class="custom-file-label" for="image_label">Choose file</label>
                          </div>
                          <span>image size : 782*351</span>
                        </div>
         ...
         <div class="container-fluid">
                    <div class="col-md-12 card card-primary">
                        <div class="card-header bg-dark">
                          <h3 class="card-title">Edit kW Output</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="form" action="{{url('/boiler/option_update')}}" method="POST">
                          ...
                          <div class="card-body">
                            ...
                            <div class="row">
                              <div class="col-md-10 offset-md-1">
                                <textarea id = "main2" class= "builder" name = "comparison_firstcontainer_kwoutput">
                                  <?php  
                                      if(isset($comparison_firstcontainer_kwoutput) && ($comparison_firstcontainer_kwoutput) ){
                                          echo $firstcontainerHtml = json_decode($comparison_firstcontainer_kwoutput)->value;
                                      }
                                  ?>    
                                </textarea>
                              </div>
          ...
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Comparison Kw Output</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="form" action="{{url('/boiler/option_update')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div id="center_image" class="w-50 mx-auto">
                        <img src="{{ (@$image2)?asset('images/boilerfinance/'.$image2):asset('images/no_image.jpg') }}" id="output2" width="125px" height="125px" style="border: 2px solid black;">
                      </div>
                    </div>
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        <label for="exampleInputFile">Comparison kW Output <small></small></label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="comparison_kwoutput" value="{{old('comparison_kwoutput')}}" onchange="loadFile(event)" required="">
                            <label class="custom-file-label" for="image_label">Choose file</label>
                          </div>
                          <span>image size : 782*351</span>
                        </div>
          ...
          <div class="container-fluid">
                    <div class="col-md-12 card card-primary">
                        <div class="card-header bg-dark">
                          <h3 class="card-title">Edit Comparison Boiler Brands</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="form" action="{{url('/boiler/option_update')}}" method="POST">
                          ...
                          <div class="card-body">
                            ...
                            <div class="row">
                              <div class="col-md-10 offset-md-1">
                                <textarea id = "main3" class= "builder" name = "comparison_firstcontainer_boilerbrand">
                                  <?php  
                                      if(isset($comparison_firstcontainer_boilerbrand) && ($comparison_firstcontainer_boilerbrand) ){
                                          echo $firstcontainerHtml = json_decode($comparison_firstcontainer_boilerbrand)->value;
                                      }
                                  ?>    
                                </textarea>
                              </div>
          ...
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Comparison Boiler Brands</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="form" action="{{url('/boiler/option_update')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div id="center_image" class="w-50 mx-auto">
                        <img src="{{ (@$image3)?asset('images/boilerfinance/'.$image3):asset('images/no_image.jpg') }}" id="output3" width="125px" height="125px" style="border: 2px solid black;">
                      </div>
                    </div>
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        <label for="exampleInputFile">Comparison Boiler Brands <small></small></label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="comparison_boilerbrand" value="{{old('comparison_boilerbrand')}}" onchange="loadFile(event)" required="">
                            <label class="custom-file-label" for="image_label">Choose file</label>
                          </div>
                          <span>image size : 782*351</span>
                        </div>
