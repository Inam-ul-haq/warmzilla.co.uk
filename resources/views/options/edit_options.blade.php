...
<div class="container-fluid">
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Edit Brands Info</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-10 offset-md-1">
                      <textarea id = "brands_info" class= "builder" name = "brands_info">
                        <?php  
                            if(isset($brands_info) && ($brands_info) ){
                                echo $brands_info = json_decode($brands_info)->value;
                            }
                        ?>    
                      </textarea>
                    </div>
        ...
        <div class="container-fluid">
          ...
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Edit Home Page image</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        <label for="exampleInputFile">Edit Home Page image <small></small></label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="mainpage_image" value="{{old('mainpage_image')}}" onchange="loadFile(event)" required="">
                            <label class="custom-file-label" for="image_label">Choose file</label>
                          </div>
                          <span> image size :650*362 </span>
                        </div>
                      </div>
                    </div>
        ...
        <div class="container-fluid">
          ...
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Edit Home Page Question image</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="form" action="{{url('/boiler/option_update')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div id="center_image" class="w-50 mx-auto">
                        <img src="{{ (@$image1)?asset('images/boilerfinance/'.$image1):asset('images/no_image.jpg') }}" id="output" width="125px" height="125px" style="border: 2px solid black;">
                      </div>
                    </div>
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        <label for="exampleInputFile">Edit Home Page Question image <small></small></label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="mainpage_image1" value="{{old('mainpage_image1')}}" onchange="loadFile(event)" required="">
                            <label class="custom-file-label" for="image_label">Choose file</label>
                          </div>
