...
<div class="container-fluid">
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">System Boiler Main Image</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        <label for="exampleInputFile">System Boiler image <small></small></label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="systemboiler_page_img" value="{{old('systemboiler_page_img')}}" onchange="loadFile(event, 'systemboiler_page_img')" required="">
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              <div class="card-header bg-dark">
                <h3 class="card-title">Edit System Boiler Info</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-10 offset-md-1">
                      <textarea id = "main" class= "builder" name = "systemboiler_firstcontainer">
                        <?php  
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="pageexampleInputFile" name="systemboiler_question_img" value="{{old('systemboiler_question_img')}}" onchange="loadFile(event, 'systemboiler_question_img')" required="">
          ...
          <div class="col-md-12 card card-primary">
              ...
              <form role="form" id="form" action="{{url('/boiler/option_update')}}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-10 offset-md-1">
                          <textarea id = "questions" class= "builder" name = "systemboiler_questions">
                            <?php  
...
$(document).ready(function() {
  ...
  var loadFile = function(event, id = '') {
    if(id == 'systemboiler_question_img'){
