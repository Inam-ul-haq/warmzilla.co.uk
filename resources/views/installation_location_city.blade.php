...
@section('content')
<div class="site_wrap installation-loc-city">	

		<div class="tsrtopsection tsrtopsection2">		
			<div class="wrapper">
				<div class="row align-items-center">
					<div class="leftimg col">
						<img src="{{ (@$location->main_image)? asset('images/boilerlocation/'.$location->main_image):asset('images/installation-location-city.png') }} "width="368" height="368" alt="" title="">
					</div>
					<div class="righttext">
					    
					    @php 
					        if(isset($location->info)){
					            echo $location->info;
					        }
					    @endphp
			...
			<div class="wrapper">
				<div class="row">
					<div class="full-width cbox">
						<div class="img">
								<img src="{{ (@$location->question_image)?asset('images/boilerlocation/'.$location->question_image):asset('images/02.png') }}" width="138" height="293" alt="" title="">
						</div>
						<div class="content">
							<div id="article-ilcity">
            					    @php 
            					        if(isset($location->questions)){
            					            echo $location->questions;
            					        }
            					    @endphp							    
