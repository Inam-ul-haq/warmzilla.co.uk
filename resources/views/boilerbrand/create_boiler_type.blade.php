...
<div class="container-fluid">
          ...
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6 pl-0">
                <h1 class="m-0 text-dark">Add Boiler Brand</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Boiler Brand</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('boilerbrand.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-6  p-1">
                      <label for="name">Boiler Brand Name <small>(Max 70 Characters)</small> </label>
                      <input Brand="text" class="form-control" name="name" id="name" placeholder="Enter Boiler Brand Name" value="{{old('name')}}" required="" maxlength="70">
                    </div>
                    <div class="form-group col-md-6   p-1">
                      <label for="description">Boiler Brand Description <small>(Max 100 Characters)</small> </label>
                      <input Brand="text" name="description" class="form-control" id="description" placeholder="Enter Boiler Brand Description" value="{{old('description')}}" required="" maxlength="100">
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        <label for="exampleInputFile">Boiler Brand image <small>(Optional)</small></label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="boiler_img" value="{{old('boiler_img')}}" onchange="loadFile(event)" required="">
 ...
 <div class="form-row">
                    <div class="col-md-3">
                      <div id="center_image" class="w-50 mx-auto">
                        <img src="{{asset('images/no_image.jpg')}}" id="outputQuestion" width="125px" height="125px" style="border: 2px solid black;">
                      </div>
                    </div>
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputMainFile" name="boiler_question_img" value="{{old('boiler_question_img')}}" onchange="loadFileQuestion(event)" >
...
<!--new-->
                  <div class="form-row">
                    <div class="col-md-3">
                      <div id="center_image" class="w-50 mx-auto">
                        <img src="{{asset('images/no_image.jpg')}}" id="outputMain" width="125px" height="125px" style="border: 2px solid black;">
                      </div>
                    </div>
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputMainFile" name="boiler_main_img" value="{{ old('boiler_main_img') }}" onchange="loadFileMain(event)" required>
