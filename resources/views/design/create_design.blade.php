...
<div class="container-fluid">
          ...
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6 pl-0">
                <h1 class="m-0 text-dark">Add Design</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('designs.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6" style="border-right: 2px solid grey;">
                      ...
                      <div class="form-group col-md-12 p-1">
                        ...
                        <input type="text" class="form-control" name="design_name" id="name" placeholder="Enter Name" value="{{old('design_name')}}" required="">
                      </div>
                      <div class="form-group col-md-12 p-1">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="custom-file">
                                <input type="file" class="custom-file-input" id="exampleInputFile" name="design_img" value="{{old('design_img')}}" onchange="loadFile(event)" required="">
                      ...
                      <div class="row mt-3 mainDiv" >
                        <div class="col-md-9">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                              <input type="text" name="dimensions[]" required="required" class="form-control">  
                            </div>
                          </div>
                        </div>
                        <div class="col-md-3">
