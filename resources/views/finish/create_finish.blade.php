<?php //print_r($warranty); exit('koko'); ?>
          ...
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6 pl-0">
                <h1 class="m-0 text-dark">Add Boiler</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Add Boiler</li>
                </ol>
              </div><!-- /.col -->
            </div><!-- /.row -->
          </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          <div class="col-md-12 card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Boiler</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('finish.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="form-group col-md-12 p-1">
                    <label for="name">Name </label> <small>(Max 70 Characters)</small>
                    <input type="text" class="form-control" name="finish_name" id="name" placeholder="Enter Name" value="{{old('finish_name')}}" required="" maxlength="70">
                  </div>
                  <div class="form-group col-md-12 p-1">
                    <label for="description">Description <small>(Max 1500 Characters)</small></label>
                    <textarea maxlength="1500" name="description" id="description" class="form-control builder" placeholder="Enter description">{{old('description' ?? '')}}</textarea>
                  </div>
                  ...
                  <div class="row">
                      ...
                      <select name="boilerbrand" id = "boilerbrand" class="form-control" onchange = "brandchange()" >
                        ...
                        @if(@$boilerbrands)
                          @foreach($boilerbrands as $boilerbrand)
                            <option value="{{$boilerbrand->id}}"  > {{$boilerbrand->name}} </option>  
                          @endforeach
                        @else
                    ...
                    <div class="form-group col-md-3 p-1">
                      ...
                      <select name="boilertype" class="form-control">
                        ...
                        @if(@$boilertypes)
                          @foreach($boilertypes as $boilertype)
                            <option value="{{$boilertype->id}}" > {{$boilertype->name}} </option>  
                          @endforeach
                        @else
                      ...
                      <div class="form-group col-md-3 p-1">
                      <label for="boilertype">Brand Category</label>
                      <select name="boilercategory" id = "boilercategory" class="form-control" required>
                        ...
                        @if(@$boilercategoires)
                          @foreach($boilercategoires as $boilercategory)
                            <option value="{{$boilercategory->id}}" > {{$boilercategory->name}} ( {{$boilercategory->description }} )</option>  
                          @endforeach
                        @else
                     ...
                     <div class="form-group col-md-3 p-1">
                      <label for="boilerbrand">Fuel Type</label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="finish_img" value="{{old('finish_img')}}" onchange="loadFile(event)" required="">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-4 mt-2 p-1">
                      <label for="dimensions">Dimensions <small>(Optional)</small></label>
                      <input type="text" step=.01 name="dimensions" id="dimensions" class="form-control" placeholder="Enter Dimensions" value="{{old('kwoutput')}}" >
                     </div>    
                    <div class="form-group col-md-8 mt-2 p-1">
                      <label for="price">Brochure URL</label>
                      <input type="url" step=.01 name="brochure_url" id="brochure_url" class="form-control" placeholder="Enter Brochure URL " value="{{old('brochure_url')}}" required="">
                    </div>
                  </div>
                <!-- here -->
                  <div class="row">
                    <div class="form-group col-md-3 p-1">
                      <label for="kwoutput">Central Heating</label>
                      <input type="number" step=.01 name="kwoutput" id="kwoutput" class="form-control" placeholder="Enter KW Input" value={{ old('kwoutput')}}   required>
                      <!--<select name="kwoutput" class="form-control"  required >-->
                      <!--  @if(@$kwoutputs)-->
                      <!--    @foreach($kwoutputs as $kwoutput) -->
                      <!--      <option value="{{$kwoutput}}"  > -->
                      <!--        @if($kwoutput == 0) -->
                      <!--          No kwoutputs-->
                      <!--        @else  -->
                      <!--          {{$kwoutput}} kw-->
                    ...
                    <div class="form-group col-md-3 p-1">
                      ...
                      <input type="text" step=.01 name="flowrate" id="flowrate" class="form-control" placeholder="Enter Flow Rate" maxlength="30" value="{{old('flowrate')}}" required>
                     </div>
                    <div class="form-group col-md-3 p-1">
                      <label for="erprating">ErP Rating <small>(Max 30 Characters)</small> </label>
                      <input type="text" step=.01 name="erprating" id="erprating" class="form-control" placeholder="Enter Erp Rating" maxlength="30" value="{{old('erprating')}}" >
                     </div>                     
                   </div>  
                  <div class="row">
                    <div class="form-group col-md-3 p-1">
                      <label for="Warranty">Warranty <small>(Max 30 Characters)</small> </label> 
                      <input type="text" step=.01 name="warranty" id="warranty" class="form-control" maxlength="30" placeholder="Enter Warranty" value="{{old('warranty')}}" >
                     </div>          
                    <div class="form-group col-md-3 p-1">
                      <label for="energyefficiency">Energy Efficiency <small>(Max 30 Characters) </small> </label>
                      <input type="text" step=.01 name="energyefficiency" id="energyefficiency" maxlength="30" class="form-control" placeholder="Enter Energy Efficiency" value="{{old('energyefficiency')}}" required>
                     </div>                               
                     <div class="form-group col-md-3 p-1">
                      <label for="review">Review Score</label>
                      <input type="number" step=.01 name="review" id="review" class="form-control" placeholder="Enter Review Score in Percentage" value="{{$finish->review ?? old('review')}}  " >
                    </div>   
                   </div>  
                   <label>Review Section:</label>
                  <div class="row">
                    <div class="form-group col-md-6  p-1">
                      <label for="features">Features <small>(Max 300 Characters) (Optional)</small></label>
                      <textarea class="form-control builder" name="features" id="features" cols="5" maxlength="300" >{{old('features' ?? '')}}</textarea>
                     </div>                  
                    ...
                    <div class="row">
                        <div class="form-group col-md-6  p-1">
                            ...
                            <textarea class="form-control builder" name="review_section" id="review_section" cols="5" maxlength = "1500">{{  old('review_section')}}</textarea>
                        </div>                  
                        <div class="form-group col-md-4 p-1"></div>                               
                   </div>        
                  ...
                  <div class="form-row">
                    <div class="col-md-3">
                      <div id="center_image" class="w-50 mx-auto">
                        <img src="{{asset('images/no_image.jpg')}}" id="output1" width="125px" height="125px" style="border: 2px solid black;">
                      </div>
                    </div>
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="review_img1" value="{{ old('review_img1') }}" onchange="loadFile1(event)">
                  ...
                  <div class="form-row">
                    <div class="col-md-3">
                      <div id="center_image" class="w-50 mx-auto">
                        <img src="{{asset('images/no_image.jpg')}}" id="output2" width="125px" height="125px" style="border: 2px solid black;">
                      </div>
                    </div>
                    <div class="col-md-9 pt-3">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="review_img2" value="{{old('review_img2') }}" onchange="loadFile2(event)">
