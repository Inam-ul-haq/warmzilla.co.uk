            ...
            <div class="tab-content clearfix">
              ...
              <div class="tab-pane" id="tab3">
                ...
                <div class="card-main">
                  ...
                  <div class="card">
                    <div class="card-figure">
                      <input type="checkbox" name="design" value="{{$design->id}}" class="design_checkboxes" id="design{{$key}}"/><label for="design{{$key}}" class="design_checkboxess"></label>
                    </div>
                ...
                <div class="action-grid">
                  <button type="button" class="btn btn-prev prev-step float-left">Previous</button>
                  <button type="button" class="btn btn-next next-step dimension_next design_next_btn" disabled="">Nexttt</button>
                </div>
              </div>
                ...
                <h3>Estimate tabs 4</h3>
                    ...
                    <div class="form-group">
                        ...
                        <div class="thiknes_input">
                            <input type="number" min="12" value="12" class="form-control" name="thickness">
                            <apan>mm</apan>
                        </div>
                    </div>
              ...
              <div class="tab-pane" id="tab5">
                ...
                <div class="estimate_summary"></div>
                <div class="action-grid">
                  <button type="button" class="btn btn-prev prev-step float-left">Previous</button>
                  <button type="submit" class="btn btn-next next-step" id="estimate_submit_btn">Submit</button>
                </div>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
  ...
  $(".double_sink_bowl").change(function(){
    ...
    $('.create_estimate_btn').attr('disabled' , true);
      $('.sink_bowl_append').append('<div class="double_sink_bowl_append_dv"><div class="thiknes_input"><p>First Sink Bowl Lenght Width</p><label>Length</label><input type="number" class="form-control sink_bowl_input" min="1" name="sink_bowl[double][length][]"><span>Inches</span><label class="hob_width">Width</label><input type="number" class="form-control sink_bowl_input" min="1" name="sink_bowl[double][width][]"><span>Inches</span></div><div class="thiknes_input"><p>Second Sink Bowl Lenght Width</p><label>Length</label><input type="number" class="form-control sink_bowl_input" min="1" name="sink_bowl[double][length][]"><span>Inches</span><label class="hob_width">Width</label><input type="number" class="form-control sink_bowl_input" min="1" name="sink_bowl[double][width][]"><span>Inches</span></div></div>');
    });
