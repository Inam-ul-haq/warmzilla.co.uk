			...
			<div class="sb-wrap">
				...
				<div class="sbthumbs-wrap">
					<div class="head-para">
						...
						<p>Currently displaying WarmZilla’s best-selling <span>{{ $brand->name }}</span> boilers. Use the filter to create your own custom <span>{{ $brand->name }}</span> boiler search.</p>
